...
[![Latest Release](https://img.shields.io/badge/Release-v1.9.0-green?style=flat-square)](https://github.com/x-name15/wachiman-cli/releases)
...
- [v1.9.0 - CHANGE LOG](CHANGELOG.md)
- [v1.9.0 - Release notes](https://github.com/x-name15/wachiman-cli/releases/tag/1.9.0)
