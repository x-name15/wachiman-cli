...
[![Latest Release](https://img.shields.io/badge/Release-v2.0.0-green?style=flat-square)](https://github.com/x-name15/wachiman-cli/releases)
...
- [v2.0.0 - CHANGE LOG](CHANGELOG.md)
- [v2.0.0 - Release notes](https://github.com/x-name15/wachiman-cli/releases/tag/2.0.0)
